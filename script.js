...
let debuffItem1; let debuffItem2; let cryo1; let cryo2; let dice;// not important items
// end of saving current round's items

let roundCount = 1;

// document.querySelector(".teamDisplay").innerHTML = teamDisplay;
// let btn=document.querySelector('.btn');
// btn.addEventListener('click', displayQuote);

function removeResultDisplay(){
    // able to hide everything with .unused that is the new class created in this javascript
    document.querySelector(".unused").style.display = "none";
    
    // round count disappears too
    document.getElementById("roundCounterbtn").style.display = "none";

    // making all generated items disappear
    document.getElementById("teamdisplay").className = "unused";
    document.getElementById("picdisplay").style.display = "none";
    document.getElementById("picdisplay1").style.display = "none";
    mmm = `<p></p>`;
    document.querySelector('#teamA').innerHTML = mmm;
    document.querySelector('#teamB').innerHTML = mmm;
    document.getElementById('boss').innerHTML = mmm;
    document.getElementById('debuff').innerHTML = mmm;
    document.getElementById('cryo').innerHTML = mmm;
    document.getElementById('d20').innerHTML = mmm;
}
